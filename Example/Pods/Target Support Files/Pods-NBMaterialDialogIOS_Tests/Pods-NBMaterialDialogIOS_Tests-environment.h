...
// NBMaterialDialogIOS
#define COCOAPODS_POD_AVAILABLE_NBMaterialDialogIOS
#define COCOAPODS_VERSION_MAJOR_NBMaterialDialogIOS 0
#define COCOAPODS_VERSION_MINOR_NBMaterialDialogIOS 1
#define COCOAPODS_VERSION_PATCH_NBMaterialDialogIOS 0
